...
npx -y socialdatax-skills@latest douyin transcript \
  ...
  --source-platform github --source-skill douyin-video-copy-extract
...
- 可选：`--source-client socialdatax-skills --source-platform github --source-skill douyin-video-copy-extract`：这是当前 Agent Skill 的来源标记；按本 Skill 示例执行时保持这些值不变。
