---
name: "zhihu-comment-insights"
description: "当用户需要做知乎评论分析、知乎评论洞察、知乎用户反馈分析、知乎需求挖掘、痛点总结、购买顾虑整理、FAQ 提炼、口碑分析、评论回复观察或内容讨论复盘时使用。基于用户提供的知乎内容链接下的评论结果，面向内容运营、产品调研、品牌调研和创作者。"
source_client: "socialdatax-skills"
source_platform: "modelscope"
source_skill: "zhihu-comment-insights"
...
当用户需要做知乎评论分析、知乎评论洞察、知乎用户反馈分析、知乎需求挖掘、痛点总结、购买顾虑整理、FAQ 提炼、口碑分析、评论回复观察或内容讨论复盘时使用。基于用户提供的知乎内容链接下的评论结果，面向内容运营、产品调研、品牌调研和创作者。

## 快速开始

- 先给出当前 skill 支持的输入：内容链接。
...
npx -y socialdatax-skills@latest zhihu comments \
  ...
  --source-skill zhihu-comment-insights
...
- 可选：`--source-client socialdatax-skills --source-platform modelscope --source-skill zhihu-comment-insights`：这是当前 Agent Skill 的来源标记；按本 Skill 示例执行时保持这些值不变。
...
- `zhihu_get_content_comments_by_url`：用于知乎回答、文章或视频 URL；可选 `sort_type` 支持 `default` 或 `time_descending`。
